...
- **Mac**: [Download the .dmg](https://github.com/twinsavior/hivemind/releases/download/v1.0.0-beta.10/HIVEMIND-1.0.0-beta.10-arm64.dmg) → open it → drag HIVEMIND to Applications
  - First launch: right-click the app → Open (macOS requires this for unsigned apps)
- **Windows**: [Download the .exe](https://github.com/twinsavior/hivemind/releases/download/v1.0.0-beta.10/HIVEMIND-Setup-1.0.0-beta.10.exe) → run it → done
