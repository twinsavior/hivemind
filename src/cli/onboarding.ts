...
// Re-export shared profile types and functions for backward compatibility.
// New consumers should import from '../shared/profile.js' directly.
export {
  DEFAULT_AGENT_ORDER,
  ROLE_OPTIONS,
  STAGE_OPTIONS,
...
// Note: DEFAULT_AGENTS, cloneAgents, defaultUserName, getHivemindHome,
// getProfilePath moved to ../shared/profile.ts

// Note: getDefaultProfile, normalizeProfile, loadProfile, loadProfileOrDefault,
// saveProfile, isFirstRun, buildFirstTaskSuggestion moved to ../shared/profile.ts
