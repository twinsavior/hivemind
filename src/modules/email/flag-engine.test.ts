...
import { templateToRule, allTemplateRules, makeRule } from './__fixtures__/rule-fixtures.js';
import {
  makeEmail,
...
} from './__fixtures__/email-fixtures.js';
import { RETAILER_TEMPLATES } from './retailer-templates.js';
