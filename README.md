...
[![Download for Mac](https://img.shields.io/badge/Download_for_Mac-.dmg-0078D4?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/twinsavior/hivemind/releases/download/v1.0.0-beta.15/HIVEMIND-1.0.0-beta.15-arm64.dmg)
[![Download for Windows](https://img.shields.io/badge/Download_for_Windows-.exe-0078D4?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/twinsavior/hivemind/releases/download/v1.0.0-beta.15/HIVEMIND-Setup-1.0.0-beta.15.exe)

[![version](https://img.shields.io/badge/version-v1.0.0--beta.15-blue)](https://github.com/twinsavior/hivemind/releases)
...
- **Mac**: [Download the .dmg](https://github.com/twinsavior/hivemind/releases/download/v1.0.0-beta.15/HIVEMIND-1.0.0-beta.15-arm64.dmg) → open it → drag HIVEMIND to Applications
  - First launch: right-click the app → Open (macOS requires this for unsigned apps)
- **Windows**: [Download the .exe](https://github.com/twinsavior/hivemind/releases/download/v1.0.0-beta.15/HIVEMIND-Setup-1.0.0-beta.15.exe) → run it → done
