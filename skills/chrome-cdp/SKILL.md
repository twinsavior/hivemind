...
version: 1.0.0
agent: scout
description: "Browser automation via Chrome DevTools Protocol — screenshots, page scraping, clicking, typing. Use when the user asks to inspect, screenshot, or interact with a page open in Chrome."
triggers: ["screenshot", "browse", "click", "scrape page", "inspect page", "chrome", "open tab", "accessibility tree", "page content"]
